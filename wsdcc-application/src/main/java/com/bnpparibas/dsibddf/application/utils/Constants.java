...
public final class Constants {
     ...
     * Service Virement
     */
    public final static String M_SERVICE_DCC = "DCC";

    /**
     * SubService Virement
     */
    public final static String M_SUBSERVICE_DCC_ELIGIBILITE = "GET_DCC_ELIGIBILITE";

    public final static String M_SUBSERVICE_DCC_CHOIX_RET = "CHOIX_RET";

    /**
     * SUBSERVICE_JOURNALISATION
     */
    public final static String SUBSERVICE_JOURNALISATION = "JOURNALISATION";
     ...
     * SUBSERVICE
     */
    public final static String SUBSERVICE = "subservice";
     ...
     * CHAINE_SERVICE
     */
    public final static String CHAINE_SERVICE = "Service : ";

    /**
     * CHAINE_SERVICE
     */
    public final static String CHAINE_ID_SESSION = "idSession : ";

    /**
     * CHAINE_SUBSERVICE
     */
    public final static String CHAINE_SUBSERVICE = "Subservice : ";

    /**
     * CHAINE_CONTEXT
     */
    public final static String CHAINE_CONTEXT = "Context : ";

    /**
     * ENCODAGE_ISO_8859_1
     */
    public final static String ENCODAGE_ISO_8859_1 = "ISO-8859-1";

    /**
     * CHAINE_TRUE
     */
    public final static String CHAINE_TRUE = "true";
    /**
     * CHAINE_CARTE
     */
    public final static String CHAINE_CARTE = "CARTE : ";
     ...
     * CHAINE_NO_TERMINAL
     */
    public final static String CHAINE_NO_TERMINAL = "NO TERMINAL : ";

    /**
     * NO_TERMINAL
     */
    public final static String NO_TERMINAL = "NO TERMINAL";

    /**
     * CHAINE_MONTANT
     */
    public final static String CHAINE_MONTANT = "MONTANT : ";
     ...
     */
    public final static String CHAINE_PUISSANCE_MONTANT = "PUISSANCE MONTANT : ";
    
    /**
     * PUISSANCE_MONTANT
     */
    public final static String PUISSANCE_MONTANT = "PUISSANCE MONTANT";

    /**
     * CHAINE_DATE
     */
    public final static String CHAINE_DATE = "DATE : ";
     ...
     * CHAINE_HEURE
     */
    public final static String CHAINE_HEURE = "HEURE : ";
    
    /**
     * HEURE
     */
    public final static String HEURE = "HEURE";

    /**
     * CHAINE_COULEURS
     */
    public final static String CHAINE_COULEURS = "Couleurs : ";

    /**
     * COULEURS
     */
    public final static String COULEURS = "Couleurs";

    /**
     * CHAINE_LARGEUR_ECRAN
     */
    public final static String CHAINE_LARGEUR_ECRAN = "Largeur écran : ";

    /**
     * LARGEUR_ECRAN
     */
    public final static String LARGEUR_ECRAN = "Largeur écran";

    /**
     * CHAINE_HAUTEUR_ECRAN
     */
    public final static String CHAINE_HAUTEUR_ECRAN = "Hauteur écran : ";

    /**
     * LARGEUR_ECRAN
     */
    public final static String HAUTEUR_ECRAN = "Hauteur écran";
    /**
     * CHAINE_fr_FR
     */
    public final static String CHAINE_FR_FR = "fr_FR";
    /**
     * CHAINE_LANGUE
     */
    public final static String CHAINE_LANGUE = "LANGUE : ";
    /**
     * CHAINE_LANGUE
     */
     ...
     * CHAINE_FOURNISSEUR
     */
    public final static String CHAINE_FOURNISSEUR = "Fournisseur : ";
    /**
     * FOURNISSEUR
     */
     ...
     * CHAINE_GAMME
     */
    public final static String CHAINE_GAMME = "Gamme : ";
    /**
     * GAMME
     */
    public final static String GAMME = "Gamme";
    /**
     * CHAINE_MODELE
     */
    public final static String CHAINE_MODELE = "Modèle : ";

    /**
     * MODELE
     */
    public final static String MODELE = "Modèle";
    /**
     * CHAINE_MODELE
     */
    public final static String CHAINE_ETAT_A4 = "ETAT A4 : ";

    /**
     * ETAT_A4
     */
    public final static String ETAT_A4 = "ETAT A4";

    /**
     * CHAINE_ETAT_TICKET
     */
    public final static String CHAINE_ETAT_TICKET = "ETAT TICKET : ";

    /**
     * ETAT_TICKET
     */
    public final static String ETAT_TICKET = "ETAT TICKET";

    /**
     * AUTOSELECTION
     */
    public final static String AUTOSELECTION = "AUTOSELECTION";

    /**
     * CHAINE_AUTOSELECTION
     */
    public final static String CHAINE_AUTOSELECTION = "AUTOSELECTION : ";

    /**
     * TYPE_ATM
     */
    public final static String TYPE_ATM = "TYPE ATM";

    /**
     * CHAINE_TYPE_ATM
     */
    public final static String CHAINE_TYPE_ATM = "TYPE ATM : ";

    /**
     * CHAINE_VIREMENT_SERVLET
     */
    public final static String CHAINE_VIREMENT_SERVLET = "/VirementServlet?";

    /**
     * EGALE
     */
    public final static String EGALE = "=";
    ...
    public final static String CSS_LABEL        = "speLabel";
    ...
    public final static String ENCODAGE_XML_UTF8 = "text/xml;charset=UTF-8";
